...
public class LdapUserResource extends UserResource {
    ...
    /*
     * @see openscim.restful.server.resources.user.UserResource#retrieveUser(javax.ws.rs.core.UriInfo,java.lang.String)
     */
    @Override
    public Response retrieveUser(@Context UriInfo uriInfo, @PathParam("uid") String uid) {
        ...
        if (ldapTemplate != null) {
            ...
            // return a server error
            return ResourceUtilities.buildErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR,
                    HttpStatus.NOT_IMPLEMENTED.getMessage() + ": Service Provider user ldap repository not configured");
        }
    }

    /*
     * @see openscim.restful.server.resources.user.UserResource#createUser(javax.ws.rs.core.UriInfo,openscim.entities.User)
     */
    @Override
    public Response createUser(UriInfo uriInfo, User user) {
        ...
        if (ldapTemplate != null) {
            ...
            try {
                ...
                /*
                 * Attribute objectclassAttribute = new BasicAttribute("objectclass"); Scanner scanner = new
                 * Scanner(objectclasses); scanner.useDelimiter(","); while(scanner.hasNext()) {
    ...
    /*
     * @see openscim.restful.server.resources.user.UserResource#updateUser(javax.ws.rs.core.UriInfo,openscim.entities.User)
     */
    @Override
    ...
    /*
     * @see openscim.restful.server.resources.user.UserResource#deleteUser(javax.ws.rs.core.UriInfo,java.lang.String)
     */
    @Override
    ...
    /*
     * @see
     * openscim.restful.server.resources.user.UserResource#deleteUser(javax.ws.rs.core.UriInfo,java.lang.String,openscim.entities
     * .User)
     */
    @Override
