...
/**
 *
 * The element element can be used either at the top level to define an element-type binding globally, or within a content model
 * to either reference a globally-defined element or type or declare an element-type binding locally. The ref form is not
...
public abstract class Element extends Annotated {
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link Keyref } {@link JAXBElement }{@code <}{@link Keybase }
     * {@code >} {@link JAXBElement }{@code <}{@link Keybase }{@code >}
     *
     *
     */
