...
public class LdapUsersResource extends UsersResource {
    // log4j contants
    private static Logger logger = Logger.getLogger(LdapUsersResource.class);
    ...
    @Override
    public Response listUsers(UriInfo uriInfo, String attributes, String filter, String sortBy, String sortOrder,
        ...
        return ResourceUtilities.buildErrorResponse(HttpStatus.NOT_IMPLEMENTED, HttpStatus.NOT_IMPLEMENTED.getMessage()
                + ": Service Provider does not support the list users operation");
    }
}
