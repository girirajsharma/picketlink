...
import org.picketlink.scim.core.entities.Error;
import org.picketlink.scim.core.entities.Group;
import org.picketlink.scim.core.entities.Meta;
...
import org.picketlink.scim.core.entities.Response;
...
public class Tests {
    ...
    public static void main(String[] args) {
        ...
        /*
         * // basic json formatted test System.out.println("json tests:");
         *
         * // test the create user functionality gid = createGroupAsJSONTest(client, factory);
         *
         * // test the retrieve group functionality retrieveGroupAsJSONTest(client, factory, gid);
         *
         * // test the update group functionality updateGroupAsJSONTest(client, factory, gid);
         *
         * // test the create user functionality uid = createUserAsJSONTest(client, factory);
         *
         * // test the retrieve user functionality retrieveUserAsJSONTest(client, factory, uid);
         *
         * // test the update user functionality updateUserAsJSONTest(client, factory, uid);
         *
         * // test the delete user functionality deleteUserTest(client, factory, uid);
         *
         * // test the delete group functionality deleteGroupTest(client, factory, gid);
         */
