...
import org.picketlink.scim.restful.server.resources.schema.SchemasResource;
...
public class LdapSchemasResource extends SchemasResource {
    // log4j contants
    private static Logger logger = Logger.getLogger(LdapSchemasResource.class);
    ...
    public Response listSchemas(UriInfo uriInfo, String resource) {
        ...
        return ResourceUtilities.buildErrorResponse(HttpStatus.NOT_IMPLEMENTED, HttpStatus.NOT_IMPLEMENTED.getMessage()
                + ": Service Provider does not support the list schemas operation");
    }
}
