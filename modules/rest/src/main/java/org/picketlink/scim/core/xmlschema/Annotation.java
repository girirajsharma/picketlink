...
public class Annotation extends OpenAttrs {
    ...
    @XmlElements({ @XmlElement(name = "documentation", type = Documentation.class),
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link Documentation } {@link Appinfo }
     *
     *
     */
